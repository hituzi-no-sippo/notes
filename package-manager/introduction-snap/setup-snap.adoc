...
:revnumber: v1.1.0
:revdate: 2021-09-06T08:17:57+0900
:revremark: snapのconfig directory pathの説明を追加
:doctype: article
...
[NOTE]
====
snapのconfig directoryは `~/snap` です。
link:https://askubuntu.com/questions/882562/how-can-i-change-or-hide-the-snap-directory[
`~/snap` から変更はできないようです。^]
====
